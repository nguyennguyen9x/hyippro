        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-12 text-center my-5 text-box">
                    <img src="<?php echo e(asset('assets/global/img/error-404.png')); ?>" alt="<?php echo app('translator')->get('not found'); ?>" width="300"/>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OT\projects\web-hyippro-php\resources\views/themes/lightagro/errors/404.blade.php ENDPATH**/ ?>