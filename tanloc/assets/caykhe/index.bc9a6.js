  ...
  "SlotCayKhe.Controller": [ function(require, module, exports) {
    ...
    let SlotCayKheController = SlotCayKheController_1 = class SlotCayKheController extends cc.Component {
      constructor() {
        ...
        this.id_cmd = null;
        this.list = null;
        this.scr_big_win = null;
        this.lb_big_win = null;
        this.scr_select_game = null;
        this.lb_select_game = null;
      }
      onLoad() {
      ...
      start() {
        ...
        BroadcastReceiver_1.default.register(BroadcastReceiver_1.default.USER_UPDATE_COIN, () => {
          Tween_1.default.numberTo(this.lblCoin, Configs_1.default.Login.Coin, .3, n => Utils_1.default.formatMoneyChip(n));
        }, this);
        BroadcastReceiver_1.default.send(BroadcastReceiver_1.default.USER_UPDATE_COIN);
        cc.log("addListener");
        this.lb_jackpot.string = "0";
        this.lb_major.string = "0";
        this.lb_maxi.string = "0";
        this.lb_mini.string = "0";
           ...
           case SlotCayKhe_Cmd_1.default.Code.UPDATE_POT:
            {
              ...
              Tween_1.default.numberTo(this.lb_mini, res.mini, .3);
              Tween_1.default.numberTo(this.lb_minior, res.minior, .3);
            }
            break;
      ...
      changeBet(evt, data) {
        ...
        switch (data) {
         case "+":
          this.pageBet.scrollToPage((pageIndex + 1) % this.list_bet.length, .2);
          break;

         case "-":
          0 == pageIndex && (pageIndex = this.list_bet.length);
          this.pageBet.scrollToPage((pageIndex - 1) % this.list_bet.length, .2);
          break;
      ...
      init(res) {
        SlotCayKheController_1.info_items = JSON.parse(res.items).object;
        SlotCayKheController_1.info_awards = JSON.parse(res.awards).object;
        cc.log(SlotCayKheController_1.info_items);
      ...
      initItem(array = []) {
        for (let index = 0; index < 5; index++) for (let id_item = 0; id_item < 5; id_item++) {
      ...
      initAnim(array = []) {
        ...
        for (let index = 0; index < 5; index++) for (let id_item = 0; id_item < 3; id_item++) {
          ...
          item.getChildByName("anim").getComponent(sp.Skeleton).skeletonData = this.anim_icon[array.length > 5 * id_item + index ? array[5 * id_item + index] : Math.min(12, 3 * index + id_item)];
          item.active = false;
      ...
      showPopupGuide() {
        ...
        popup.getComponent(SlotCayKhe_PopupGuide_1.default).init(data, this.spr_icon);
      ...
      setupBtnSpin() {
        ...
        this.sprSpin.parent.on("touchend", touch => {
          if (this.isHoldSpin) {
            this.isHoldSpin = false;
            if (this.timeHoldSpin < 1) if (this.spinMode == SpinMode.NORMAL) {
              this.spinMode = SpinMode.NORMAL;
              this.effSpin();
            } else {
              this.spinMode = SpinMode.NORMAL;
      ...
      showLine(array = [ 0, 0, 0, 0, 0 ]) {
        array = [ 0, 0, 0, 0, 0 ];
        array.forEach((value, index) => {
          value = Math.floor(3 * Math.random());
      ...
      onSpinResult(result) {
        ...
        let speedRoll = this.spinMode == SpinMode.AUTO_X2 ? .25 : .5;
        ...
        cc.log(this.parentItems.children);
        this.parentItems.children.forEach((children, index) => {
          ...
          for (let index = 0; index < 2; index++) {
            actionRoll.push(cc.callFunc(() => {
              ...
              children.getChildByName("img").getComponent(cc.Sprite).spriteFrame = this.spr_icon[Math.floor(Math.random() * this.spr_icon.length)];
      ...
      showResult(result, isShowUI) {
        if (isShowUI) {
          cc.log(result);
          this.spinMode == SpinMode.NORMAL ? this.setStateBtnSpin(true) : this.effSpin();
          this.isSpinning = false;
        }
        return 2;
      }
      ...
      showBigWin(money, callback) {
        money = 5e9;
        this.scr_big_win.stopAllActions();
        this.scr_big_win.active = true;
        this.lb_big_win.node.opacity = 0;
        this.scr_big_win.runAction(cc.sequence(cc.callFunc(() => {
          this.scr_big_win.getComponentInChildren(sp.Skeleton).setAnimation(0, "animation", false);
          this.lb_big_win.string = "0";
        }), cc.delayTime(.5), cc.callFunc(() => {
          this.lb_big_win.node.runAction(cc.fadeIn(.18));
          Tween_1.default.numberTo(this.lb_big_win, money, 1);
        }), cc.delayTime(3.8), cc.callFunc(() => {
          this.lb_big_win.node.runAction(cc.fadeOut(.18));
        }), cc.delayTime(.2), cc.callFunc(() => {
          this.scr_big_win.active = false;
    ...
    SlotCayKheController.info_items = null;
    SlotCayKheController.info_awards = null;
    ...
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_jackpot", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_major", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_maxi", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_mini", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_minior", void 0);
    __decorate([ property([ sp.SkeletonData ]) ], SlotCayKheController.prototype, "anim_icon", void 0);
    __decorate([ property([ cc.SpriteFrame ]) ], SlotCayKheController.prototype, "spr_icon", void 0);
    __decorate([ property([ cc.SpriteFrame ]) ], SlotCayKheController.prototype, "spr_blur", void 0);
    ...
    __decorate([ property(cc.Node) ], SlotCayKheController.prototype, "item_bet", void 0);
    __decorate([ property(cc.PageView) ], SlotCayKheController.prototype, "page_bet", void 0);
    ...
    __decorate([ property(cc.Node) ], SlotCayKheController.prototype, "scr_big_win", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_big_win", void 0);
    __decorate([ property(cc.Node) ], SlotCayKheController.prototype, "scr_select_game", void 0);
    __decorate([ property(cc.Label) ], SlotCayKheController.prototype, "lb_select_game", void 0);
...
}, {}, [ "SlotCayKhe.Cmd", "SlotCayKhe.Controller", "SlotCayKhe.ControllerOffline", "SlotCayKhe.PopupBonus", "SlotCayKhe.PopupGuide", "SlotCayKhe.PopupHistory", "SlotCayKhe.PopupJackpotHistory", "SlotCayKhe.PopupSelectLine", "SlotCayKhe.SoundControler", "SlotCayKhe.SpinControler", "SlotCayKhe.TrialResults" ]);