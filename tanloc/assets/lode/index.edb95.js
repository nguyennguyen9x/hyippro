window.__require = function e(t, n, r) {
  ...
  "LoDeSieuToc.Chat": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "451baw8Lr9HW5wa/WZeAmM9", "LoDeSieuToc.Chat");
    "use strict";
    var __decorate = this && this.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) r = Reflect.decorate(decorators, target, key, desc); else for (var i = decorators.length - 1; i >= 0; i--) (d = decorators[i]) && (r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r);
    ...
    const LoDe_Cmd_1 = require("./LoDe.Cmd");
    const {ccclass: ccclass, property: property} = cc._decorator;
    let LoDeSieuTocChat = class LoDeSieuTocChat extends cc.Component {
      constructor() {
        super(...arguments);
        this.chatItem = null;
      ...
      addChat(message) {
        ...
        null == item && (item = this.chatContent.childrenCount >= 20 ? this.chatContent.children[0] : cc.instantiate(this.chatItem));
        var zIndex = 0;
        for (var i = 0; i < this.chatContent.childrenCount; i++) {
          let node = this.chatContent.children[i];
          node != item && (node.zIndex = zIndex++);
    ...
    __decorate([ property(cc.Node) ], LoDeSieuTocChat.prototype, "chatItem", void 0);
    __decorate([ property(cc.Node) ], LoDeSieuTocChat.prototype, "chatContent", void 0);
    __decorate([ property(cc.EditBox) ], LoDeSieuTocChat.prototype, "edbChat", void 0);
    __decorate([ property(cc.SpriteAtlas) ], LoDeSieuTocChat.prototype, "atlasVip", void 0);
    LoDeSieuTocChat = __decorate([ ccclass ], LoDeSieuTocChat);
    exports.default = LoDeSieuTocChat;
    cc._RF.pop();
  }, {
    "../../Main/Game/src/common/App": void 0,
    "../../Main/Game/src/common/BroadcastReceiver": void 0,
  ...
  "LoDeSieuToc.Controller": [ function(require, module, exports) {
    ...
    const LoDeSieuToc_Chat_1 = require("./LoDeSieuToc.Chat");
    ...
    __decorate([ property(LoDeSieuToc_Chat_1.default) ], LoDeSieuTocController.prototype, "chat", void 0);
    ...
    "../../Main/Lobby/src/Lobby.PopupShop": void 0,
    "./LoDe.Cmd": "LoDe.Cmd",
    "./LoDeSieuToc.Chat": "LoDeSieuToc.Chat",
  ...
  "LoDeSieuToc.GlobalBet": [ function(require, module, exports) {
      ...
      requestGetGlobalBetHistory() {
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "getGlobalHistory", {
          ...
          Http_1.default.get(Configs_1.default.App.API, {
            ...
            for (let i = 0; i < historys.length; i++) {
              const history = historys[i];
              let historyItem = this.globalBetContent.children[i];
              if (!historyItem) {
                historyItem = cc.instantiate(this.globalBetItem);
                historyItem.parent = this.globalBetContent;
              }
              historyItem.active = true;
              let lbs = historyItem.getComponentsInChildren(cc.Label);
    ...
    __decorate([ property(cc.Node) ], LoDeSieuTocGlobalBet.prototype, "globalBetContent", void 0);
  ...
  "LoDeSieuToc.Play": [ function(require, module, exports) {
    ...
    let LoDeSieuTocPlay = LoDeSieuTocPlay_1 = class LoDeSieuTocPlay extends cc.Component {
        ...
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "matchInfo", {
          ...
          this.countDownTimeRelease = () => {
            if (this.countDown < 0) {
              ...
              if (res.countDown > 0) {
                this.requestLatestResult(true, true);
                this.scheduleOnce(() => {
                  LoDeSieuToc_History_1.default.getInstance().checkBetResult(this.matchId);
                }, 7);
              }
            } else {
      ...
      requestLatestResult(isCurrentMatch, isDelay = false) {
        let date = new Date(this.dateOfBet);
        isCurrentMatch || date.setMinutes(date.getMinutes() - this.getCurrentSieuTocGameType().intervalSeconds / 60);
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "info", {
          cityId: this.getCurrentCity().id,
          quickGameType: this.getCurrentSieuTocGameType().name,
          date: this.getLongSession(date)
        }, (err, res) => {
          if (!this.node) return;
          if (null != err) return;
          cc.log(res);
  ...
  "LoDeSieuToc.PopupResult": [ function(require, module, exports) {
    ...
    let LoDeSieuTocPopupResult = class LoDeSieuTocPopupResult extends LoDeSieuToc_Dialog_1.default {
      ...
      actionGetMatchResult() {
        ...
        let ids = this.edbMatchId.string.split("-");
        if (ids.length < 2 || 8 !== ids[0].length || 4 != ids[1].length) {
          this.removeAllItemResult();
          return;
        }
        let date = [ ids[0].slice(0, 4), ids[0].slice(4, 6), ids[0].slice(6, 8) ].join("-");
        let hour = [ ids[1].slice(0, 2), ids[1].slice(2, 4), "00" ].join(":");
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "info", {
          cityId: LoDeSieuToc_Controller_1.default.getInstance().allCities[this.dropDownCities.getValue()].id,
          quickGameType: LoDeSieuToc_Controller_1.default.getInstance().sieuTocGameTypes[this.dropdownGameTypes.getValue()].name,
          date: [ date, hour ].join("T")
        }, (err, res) => {
          if (!this.node) return;
          if (null != err) return;
          cc.log(res);
  ...
  "Lode.LodeData": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "feb2cdHy0BNNbCt7k5S+S+f", "Lode.LodeData");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
  ...
  "LodeSieuToc.History": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "7c046re1sVPOYblx6KhTVto", "LodeSieuToc.History");
    "use strict";
    var __decorate = this && this.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) r = Reflect.decorate(decorators, target, key, desc); else for (var i = decorators.length - 1; i >= 0; i--) (d = decorators[i]) && (r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r);
    ...
    let LoDeSieuTocHistory = LoDeSieuTocHistory_1 = class LoDeSieuTocHistory extends cc.Component {
      ...
      loadData(page) {
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "getHistory", {
          ...
          for (let i = 0; i < historys.length; i++) {
            ...
            let gameMode = LoDeSieuToc_Controller_1.default.getInstance().gameModes.find(mode => mode.name == history["gameType"]);
            lbs[1].string = (gameMode ? gameMode.displayName : history["gameType"]) + "(" + LoDeSieuToc_Controller_1.default.getInstance().allCities.find(city => city.id == history["cityId"]).name + ")";
            lbs[2].string = history["betNumbers"].length > 24 ? history["betNumbers"].substr(0, 21) + "..." : history["betNumbers"];
            lbs[3].string = history["betMoney"] ? Utils_1.default.formatMoneyChip(history["betMoney"]) + "\n" + Utils_1.default.formatMoneyChip(Math.round(history["betMoney"] / history["betNumbers"].split(",").length)) + "/con" : history["betMoney"];
            lbs[4].string = history["prize"] ? Utils_1.default.formatMoneyChip(history["prize"]) : "";
            lbs[5].string = history["isRewarded"] ? history["prize"] > 0 ? "Tr\xfang" : "Tr\u01b0\u1ee3t" : "Ch\u1edd k\u1ebft qu\u1ea3";
          ...
          let historysNearestNoResult = historys.filter(history => !history["isRewarded"]);
          historysNearestNoResult.sort((a, b) => a.createTime - b.createTime);
          let historyNearest = historysNearestNoResult[0];
          if (historyNearest) {
            let timeRelease = new Date(historyNearest.matchDateTime);
            let quickGameType = LoDeSieuToc_Controller_1.default.getInstance().sieuTocGameTypes.find(gameType => gameType.name === historyNearest.quickGameType);
            timeRelease.setSeconds(timeRelease.getSeconds() + quickGameType.intervalSeconds);
            let timeSchedule = Math.ceil((timeRelease.getTime() - Date.now()) / 1e3);
            timeSchedule > 0 && this.scheduleOnce(() => {
              this.loadData(this.currentPage);
            }, timeSchedule);
          }
        });
      ...
      checkBetResult(matchId) {
        Http_1.default.get(Configs_1.default.App.API_LODE_SIEU_TOC + "getHistory", {
          ...
          let historys = res["lotteryResults"];
          let historyCurrentMatch = historys.filter(history => history.matchDateTimeString === matchId && history.prize > 0);
          if (0 === historyCurrentMatch.length) return;
          for (let i = 0; i < historyCurrentMatch.length; i++) {
            const history = historyCurrentMatch[i];
            this.scheduleOnce(() => {
              App_1.default.instance.toast.showToast("Th\u1eafng " + Utils_1.default.formatMoney(history.prize) + " " + LoDeSieuToc_Controller_1.default.getInstance().gameModes.find(mode => mode.name === history.gameType).getSieuTocDisplayName() + ", " + LoDeSieuToc_Controller_1.default.getInstance().cities.find(city => city.id === history.cityId).name);
            }, 1.5 * i);
          }
        });
      }
...
}, {}, [ "LoDe.CalendarBet", "LoDe.CalendarResult", "LoDe.Cmd", "LoDe.Controller", "LoDe.PopupSelectNumber", "LoDeSieuToc.Chat", "LoDeSieuToc.Controller", "LoDeSieuToc.Dialog", "LoDeSieuToc.GlobalBet", "LoDeSieuToc.Play", "LoDeSieuToc.PopupGuide", "LoDeSieuToc.PopupHonors", "LoDeSieuToc.PopupResult", "LoDeSieuToc.PopupSelectNumber", "Lode.LodeData", "Lode.PopupGuide", "Lode.PopupHistory", "Lode.PopupHonors", "LodeSieuToc.History" ]);