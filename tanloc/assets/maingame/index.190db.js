window.__require = function e(t, n, r) {
  ...
  App: [ function(require, module, exports) {
    ...
    let App = App_1 = class App extends cc.Component {
      ...
      onLoad() {
        cc.game.addPersistRootNode(this.toast.node);
    ...
    __decorate([ property(cc.Node) ], App.prototype, "animationSwipeUp", void 0);
  ...
  Configs: [ function(require, module, exports) {
    ...
    (function(Configs) {
      ...
      App.API_LIXI = "https://gameapi." + App.BASE_URL + "/event/tanloc/";
      App.TELE_GROUP = "";
      App.TELE_BOT = "";
      App.TELE_OTP = "";
  ...
  LixiNetworkClient: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e830dM3FHVL87lVwztJCJGu", "LixiNetworkClient");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    const Network_InPacket_1 = require("./Network.InPacket");
    const Network_Cmd_1 = require("./Network.Cmd");
    class LixiNetworkClient extends Network_NetworkClient_1.default {
      constructor() {
        super();
        this.listeners = new Array();
        this.isLogin = false;
      ...
      static getInstance() {
        null == this.instance && (this.instance = new LixiNetworkClient());
        return this.instance;
      }
    ...
    exports.default = LixiNetworkClient;
    cc._RF.pop();
  }, {
    "../common/Configs": "Configs",
    "./Network.Cmd": "Network.Cmd",
  ...
  "Lobby.BannerLiXi": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "29ee07OIGlH0rtZEvXGZ36b", "Lobby.BannerLiXi");
    "use strict";
    var __decorate = this && this.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) r = Reflect.decorate(decorators, target, key, desc); else for (var i = decorators.length - 1; i >= 0; i--) (d = decorators[i]) && (r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r);
    ...
    const Lobby_PopupLiXi_1 = require("./Lobby.PopupLiXi");
    const {ccclass: ccclass, property: property} = cc._decorator;
    let BannerLiXi = BannerLiXi_1 = class BannerLiXi extends Dialog_1.default {
      constructor() {
        super(...arguments);
        this.btnSkipBanner = null;
      }
      static createAndShow(parent) {
        let date = new Date();
        BannerLiXi_1.skipInDate = date.getDay() + "/" + date.getMonth() + "/" + date.getFullYear();
        let isSkipBanner = false;
        if (!this.initing && !isSkipBanner) if (null == this.instance || null == this.instance.node) {
          this.initing = true;
          App_1.default.instance.loadPrefab("Lobby/res/prefabs/banner/BannerLiXi", (err, prefab) => {
            this.initing = false;
            if (null != err) {
              cc.log(this.skipInDate, err);
              App_1.default.instance.alertDialog.showMsg(err);
              return;
            }
            let go = cc.instantiate(prefab);
            go.parent = parent;
            this.instance = go.getComponent(BannerLiXi_1);
            this.instance.show();
          });
        } else this.instance.show();
      }
      dismiss() {
        cc.sys.localStorage.setItem(BannerLiXi_1.skipInDate, this.btnSkipBanner.isChecked);
        super.dismiss();
      }
      click() {
        Lobby_PopupLiXi_1.default.createAndShow(App_1.default.instance.popups);
        this.dismiss();
      }
    };
    BannerLiXi.skipInDate = "";
    BannerLiXi.instance = null;
    BannerLiXi.initing = false;
    __decorate([ property(cc.Toggle) ], BannerLiXi.prototype, "btnSkipBanner", void 0);
    BannerLiXi = BannerLiXi_1 = __decorate([ ccclass ], BannerLiXi);
    exports.default = BannerLiXi;
    cc._RF.pop();
  }, {
    "../../../Game/src/common/App": "App",
    "../../../Game/src/common/Dialog": "Dialog",
    "./Lobby.PopupLiXi": "Lobby.PopupLiXi"
  } ],
  "Lobby.Banner": [ function(require, module, exports) {
    ...
    const {ccclass: ccclass, property: property} = cc._decorator;
    let Banner = class Banner extends cc.Component {
      constructor() {
        super(...arguments);
    ...
    __decorate([ property(cc.PageView) ], Banner.prototype, "bannerPageView", void 0);
    __decorate([ property(cc.Node) ], Banner.prototype, "bannerItem", void 0);
    Banner = __decorate([ ccclass ], Banner);
    ...
    let ButtonLiXi = class ButtonLiXi extends cc.Component {
      ...
      getLiXiConfig() {
        Http_1.default.get(Configs_1.default.App.API_LIXI + "config", {}, (err, res) => {
          if (null != err) return;
          cc.log(res);
          Lobby_PopupLiXi_1.default.fund = res.fund;
          Lobby_PopupLiXi_1.default.numberUserRegister = res.numberUserRegister;
          Lobby_PopupLiXi_1.default.numberUserShare = res.numberUserShare;
        });
      }
    };
  ...
  "Lobby.LobbyController": [ function(require, module, exports) {
    ...
    const Lobby_PopupLiXi_1 = require("./Lixi/Lobby.PopupLiXi");
    const Lobby_BannerLiXi_1 = require("./Lixi/Lobby.BannerLiXi");
    ...
    (function(Lobby) {
      ...
      let LobbyController = LobbyController_1 = class LobbyController extends cc.Component {
        ...
        showBannerLiXi() {
          Lobby_BannerLiXi_1.default.createAndShow(App_1.default.instance.popups);
        }
      };
    ...
    "./Lixi/Lobby.BannerLiXi": "Lobby.BannerLiXi",
    "./Lixi/Lobby.PopupLiXi": "Lobby.PopupLiXi",
  ...
  "Lobby.PopupLiXi": [ function(require, module, exports) {
    ...
    const Dialog_1 = require("../../../Game/src/common/Dialog");
    const Http_1 = require("../../../Game/src/common/Http");
    const LixiNetworkClient_1 = require("../../../Game/src/networks/LixiNetworkClient");
    const Network_InPacket_1 = require("../../../Game/src/networks/Network.InPacket");
    const Lixi_cmd_1 = require("./Lixi.cmd");
    const PanelChat_1 = require("./PanelChat");
    const {ccclass: ccclass, property: property} = cc._decorator;
    let PopupLiXi = PopupLiXi_1 = class PopupLiXi extends Dialog_1.default {
      constructor() {
        super(...arguments);
        this.PanelChat = null;
        this.userInList = [];
      ...
      static createAndShow(parent) {
        if (!this.initing) if (null == this.instance || null == this.instance.node) {
          this.initing = true;
          App_1.default.instance.loadPrefab("Lobby/res/prefabs/popups/PopupLiXi", (err, prefab) => {
            LixiNetworkClient_1.default.getInstance().checkConnect(() => {
              if (null != prefab) {
                ...
                let go = cc.instantiate(prefab);
                go.parent = parent;
                this.instance = go.getComponent(PopupLiXi_1);
                this.instance.show();
              } else cc.log(err);
            });
          });
      ...
      openLiXi() {}
      addResult(num) {
        num = Math.floor(100 * Math.random());
      ...
      checkTicket() {
        this.listResult.forEach(num => {
          ...
          if (!cell_win) return cc.log("find cell_win error");
          cc.log("find cell_win oki");
      ...
      setCellInTicket(idx, status = 0, num = -1) {
        ...
        cell.getChildByName("FREE").active = status > 1;
      }
      setTicket(list) {
        list = [];
    ...
    PopupLiXi.instance = null;
    PopupLiXi.initing = false;
    ...
    "../../../Game/src/common/Dialog": "Dialog",
    "../../../Game/src/common/Http": "Http",
    "../../../Game/src/networks/LixiNetworkClient": "LixiNetworkClient",
    "../../../Game/src/networks/Network.InPacket": "Network.InPacket",
    "./Lixi.cmd": "Lixi.cmd",
    "./PanelChat": "PanelChat"
  } ],
  ...
  "Lobby.TabsListGame": [ function(require, module, exports) {
    ...
    let TabsListGame = class TabsListGame extends cc.Component {
      constructor() {
        ...
        this.SORT_ALL_GAME = [ "SlotSieuAnhHung", "TaiXiu", "TaiXiuMD5", "TwoGameCasino", "BanCa", "BauCua", "XocDia", "TwoGame", "SlotNuDiepVien", "TLMN", "Maubinh", "Xidach", "SlotVuongQuocVin", "SlotKhoBau", "PokerGo", "LoDe", "MiniPoker", "Bacay", "Lieng", "LoDeSieuToc" ];
        this.SORT_SLOT = [ "SlotSieuAnhHung", "SlotNuDiepVien", "SlotVuongQuocVin", "SlotKhoBau" ];
      ...
      onTabChanged() {
        ...
        cc.sys.isBrowser && sortList.push("SlotCayKhe");
  ...
  Toast: [ function(require, module, exports) {
    ...
    let Toast = class Toast extends cc.Component {
      ...
      showToast(str, time = .5, timeFade = .5, d = 80) {
        ...
        this.node.runAction(cc.sequence(cc.spawn(cc.fadeIn(timeFade / 2), cc.scaleTo(timeFade, 1, 1).easing(cc.easeBackOut())), cc.spawn(cc.moveBy(time, 0, d), cc.sequence(cc.delayTime(time / 2), cc.fadeOut(time / 2).easing(cc.easeSineIn()))), cc.callFunc(() => {
          this.node.active = false;
        })));
      }
      hide() {
    ...
    __decorate([ property(cc.Label) ], Toast.prototype, "txt", void 0);
