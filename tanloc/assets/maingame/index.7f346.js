window.__require = function e(t, n, r) {
  ...
  App: [ function(require, module, exports) {
    ...
    const AuthorizationResponseData_1 = require("../../../Lobby/src/Authorization/AuthorizationResponseData");
    const {ccclass: ccclass, property: property} = cc._decorator;
      ...
      start() {
        ...
        if (cc.sys.isBrowser) {
          window.addEventListener("message", function(e) {
            if (Configs_1.default.Login.IsLogin) return;
            try {
              const data = JSON.parse(e.data);
              data.hasOwnProperty("event") && "auth_user" === data.event && AuthorizationController_1.AuthorizationController.getInstance().loginTelegram(data.auth_data);
            } catch (error) {
              Configs_1.default.Login.ICPUser = e.data ? AuthorizationResponseData_1.ICPUser.toICPUser(e.data) : null;
              AuthorizationController_1.AuthorizationController.getInstance().onLoginICP();
            }
          });
    ...
    "../../../Lobby/src/Authorization/AuthorizationResponseData": "AuthorizationResponseData",
  ...
  AuthorizationController: [ function(require, module, exports) {
    ...
    const Lobby_PopupLoginICP_1 = require("./Lobby.PopupLoginICP");
    let FB = window.FB;
    var LOGIN_SOURCE;
    ...
    class AuthorizationController {
      ...
      loginICP() {
        Lobby_PopupLoginICP_1.default.createAndShow(App_1.default.instance.popups, "signin");
      }
      onLoginICP() {
        var _a, _b;
        if (!Configs_1.default.Login.ICPUser && !(null === (_a = Lobby_PopupProfile_1.default.instance) || void 0 === _a ? void 0 : _a.isSignOut)) return;
        null === (_b = Lobby_PopupLoginICP_1.default.instance) || void 0 === _b ? void 0 : _b.dismiss();
        if (!Configs_1.default.Login.ICPUser) {
          Lobby_PopupProfile_1.default.instance.isSignOut = false;
          return;
        }
        App_1.default.instance.showLoading(true);
        Http_1.default.post(Configs_1.default.App.API + "?c=3", {
          at: Configs_1.default.Login.ICPUser.key,
          s: LOGIN_SOURCE.PLAY_NOW,
          app_id: Configs_1.default.App.UPDATE_INFO.provider,
          c_v: Configs_1.default.App.UPDATE_INFO.version
        }, (err, res) => {
          ...
          this.loginHandler(loginRes, "", "", LOGIN_SOURCE.PLAY_NOW, Configs_1.default.Login.ICPUser.key);
        });
      }
      ...
      quickLogin() {
        cc.sys.isBrowser ? this.loginICP() : this.loginWithDeviceId();
      }
    }
    ...
    "./Lobby.PopupLoginICP": "Lobby.PopupLoginICP"
  } ],
  AuthorizationResponseData: [ function(require, module, exports) {
    ...
    exports.ICPData = exports.ICPUser = exports.LoginResponse = exports.UserVippointRewards = exports.SecurityPublicAttributes = exports.SecurityUserSettings = exports.UserInfoResponse = void 0;
    ...
    class ICPUser {
      static toICPUser(user) {
        let icpUser = new ICPUser();
        icpUser.data = ICPData.toICPData(user.data);
        icpUser.description = user.description;
        icpUser.key = user.key;
        icpUser.owner = user.owner;
        icpUser.updatedAt = user.updated_at;
        return icpUser;
      }
    }
    exports.ICPUser = ICPUser;
    class ICPData {
      static toICPData(data) {
        let icpData = new ICPData();
        icpData.provider = data.provider;
        return icpData;
      }
    }
    exports.ICPData = ICPData;
    cc._RF.pop();
  }, {} ],
  ...
  Configs: [ function(require, module, exports) {
    ...
    (function(Configs) {
      ...
      App.ICP_URL = "https://taiwin365.com/icp/?type=";
      App.TELE_GROUP = "";
      App.TELE_BOT = "";
      App.TELE_OTP = "";
  ...
  "Lobby.ButtonTanLoc": [ function(require, module, exports) {
    ...
    let ButtonTanLoc = class ButtonTanLoc extends cc.Component {
      ...
      setCountDown(countDown) {
        ...
        this.lbTime && (this.lbTime.string = [ hours < 10 ? "0" + hours : hours, minutes < 10 ? "0" + minutes : minutes, seconds < 10 ? "0" + seconds : seconds ].join(":"));
      }
    };
  ...
  "Lobby.LobbyController": [ function(require, module, exports) {
    ...
    (function(Lobby) {
      ...
      let LobbyController = LobbyController_1 = class LobbyController extends cc.Component {
        ...
        actQickLogin() {
          AuthorizationController_1.AuthorizationController.getInstance().quickLogin();
        }
        getUserInfo() {
          Http_1.default.get(Configs_1.default.App.API, {
            c: 6027
  ...
  "Lobby.PopupLoginICP": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "482b9L4k4hLTqzooa4nbYjG", "Lobby.PopupLoginICP");
    "use strict";
    var __decorate = this && this.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) r = Reflect.decorate(decorators, target, key, desc); else for (var i = decorators.length - 1; i >= 0; i--) (d = decorators[i]) && (r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r);
    ...
    const Configs_1 = require("../../../Game/src/common/Configs");
    const {ccclass: ccclass, property: property} = cc._decorator;
    let PopupLoginICP = PopupLoginICP_1 = class PopupLoginICP extends Dialog_1.default {
      constructor() {
        super(...arguments);
        this.webview = null;
      }
      static createAndShow(parent, type) {
        null == this.instance || null == this.instance.node ? App_1.default.instance.loadPrefab("Lobby/res/prefabs/popups/PopupLoginICP", (err, prefab) => {
          if (null != err) return;
          let go = cc.instantiate(prefab);
          go.active = false;
          go.parent = parent;
          this.instance = go.getComponent(PopupLoginICP_1);
          this.instance.showWithType(type);
        }) : this.instance.showWithType(type);
      }
      showWithType(type) {
        this.webview.url = Configs_1.default.App.ICP_URL + type;
        this.node.opacity = "signin" === type ? 255 : 1;
        super.show();
      }
    };
    PopupLoginICP.instance = null;
    __decorate([ property(cc.WebView) ], PopupLoginICP.prototype, "webview", void 0);
    PopupLoginICP = PopupLoginICP_1 = __decorate([ ccclass ], PopupLoginICP);
    exports.default = PopupLoginICP;
    cc._RF.pop();
  }, {
    "../../../Game/src/common/App": "App",
    "../../../Game/src/common/Configs": "Configs",
