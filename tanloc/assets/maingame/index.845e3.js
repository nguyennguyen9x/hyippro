window.__require = function e(t, n, r) {
  ...
  App: [ function(require, module, exports) {
    ...
    let App = App_1 = class App extends cc.Component {
      ...
      openTanLoc() {
        App_1.instance.loadSceneInBundle("tanloc", "", false, "TanLoc");
      }
  ...
  Configs: [ function(require, module, exports) {
    ...
    (function(Configs) {
      ...
      App.ICP_URL = "https://taiwin365.com/icp/";
      App.TELE_GROUP = "";
      App.TELE_BOT = "";
      App.TELE_OTP = "";
    ...
    let ButtonTanLoc = class ButtonTanLoc extends cc.Component {
      ...
      getTanLocConfig() {
        Http_1.default.get(Configs_1.default.App.API_TAN_LOC + "config", {}, (err, res) => {
          ...
          countDown >= 0 && this.setCountDown(countDown);
          this.schedule(this.scheduleBonusTime = () => {
            countDown--;
            countDown >= 0 ? this.setCountDown(countDown) : this.unschedule(this.scheduleBonusTime);
          }, 1);
        });
      }
      setCountDown(countDown) {
        if (0 == countDown) return this.lbTime.string = "\u0110ang di\u1ec5n ra";
    ...
    (function(Lobby) {
      ...
      let LobbyController = LobbyController_1 = class LobbyController extends cc.Component {
        constructor() {
          ...
          this.fireWorks = null;
          this.btnQuickLogin = null;
          this.webviewQuickLogin = null;
        ...
        start() {
          this.btnQuickLogin.active = cc.sys.isNative;
          this.webviewQuickLogin.active = cc.sys.isBrowser;
      ...
      __decorate([ property(cc.Node) ], LobbyController.prototype, "btnQuickLogin", void 0);
      __decorate([ property(cc.Node) ], LobbyController.prototype, "webviewQuickLogin", void 0);
  ...
  "Lobby.WebviewLoginICP": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4df7bqDmttCF71i2mzmLJvM", "Lobby.WebviewLoginICP");
    "use strict";
    var __decorate = this && this.__decorate || function(decorators, target, key, desc) {
      var c = arguments.length, r = c < 3 ? target : null === desc ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
      if ("object" === typeof Reflect && "function" === typeof Reflect.decorate) r = Reflect.decorate(decorators, target, key, desc); else for (var i = decorators.length - 1; i >= 0; i--) (d = decorators[i]) && (r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r);
    ...
    const Configs_1 = require("../../../Game/src/common/Configs");
    const {ccclass: ccclass, property: property} = cc._decorator;
    let WebviewLoginICP = class WebviewLoginICP extends cc.Component {
      start() {
        this.node.getComponent(cc.WebView).url = Configs_1.default.App.ICP_URL + "button";
      }
    };
    WebviewLoginICP = __decorate([ ccclass ], WebviewLoginICP);
    exports.default = WebviewLoginICP;
    cc._RF.pop();
  }, {
    "../../../Game/src/common/Configs": "Configs"
  } ],
