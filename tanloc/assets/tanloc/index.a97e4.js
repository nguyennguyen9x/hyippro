window.__require = function e(t, n, r) {
  ...
  "TanLoc.Controller": [ function(require, module, exports) {
    ...
    let TanLocController = TanLocController_1 = class TanLocController extends cc.Component {
      ...
      getInfoAward() {
        TanLoc_NetworkClient_1.default.getInstance().send(new TanLoc_Cmd_1.default.SendInfoAward());
      }
      requestConfig() {
      ...
      checkTicket() {
        ...
        this.listResult.forEach((num, idx) => {
          ...
          if (!cellWin) return;
          idx == this.listResult.length - 1 && App_1.default.instance.toast.showToast("Ch\xfac m\u1eebng, B\u1ea1n c\xf3 s\u1ed1 " + num);
      ...
      showWin(winPrize) {
        ...
        this.lbWin.string = winPrize > 0 ? Utils_1.default.formatNumber(winPrize) : "Ch\xfac m\u1eebng !";
...
}, {}, [ "TanLoc.Cmd", "TanLoc.Controller", "TanLoc.Dialog", "TanLoc.NetworkClient", "TanLoc.PanelChat", "TanLoc.PopupGuide", "TanLoc.PopupHistory", "TanLoc.PopupHonors", "TanLoc.PopupTanLoc" ]);