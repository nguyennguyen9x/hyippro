    ...
    let TanLocController = TanLocController_1 = class TanLocController extends cc.Component {
           ...
           case TanLoc_Cmd_1.default.Code.SUBCRIBE_RESPONSE:
            {
              ...
              this.stepGame = res.isSpinBingo ? "SPIN" : "WAIT";
            }
            break;
           ...
           case TanLoc_Cmd_1.default.Code.INFO_ROUND:
            {
              ...
              this.stepGame = "WAIT";
              this.setCountDown(60 * res.countDown);
            }
            break;
      ...
      requestConfig() {
        Http_1.default.get(Configs_1.default.App.API_TAN_LOC + "config", {}, (err, res) => {
          ...
          this.scheduleBonusTime || this.setCountDown(countDown);
          countDown > 0 && this.scheduleOnce(() => {
            this.requestConfig();
          }, 10);
      ...
      setCountDown(countDown) {
        ...
        if (isWaitTime) this.lbTimeWanting.string = [ hours < 10 ? "0" + hours : hours, minutes < 10 ? "0" + minutes : minutes, seconds < 10 ? "0" + seconds : seconds ].join(":"); else {
      ...
      showLineWin(line = [ -1, -1, -1, -1, -1 ]) {
        ...
        line.forEach(num => {
          ...
          action.push(cc.callFunc(() => {
            ...
            cc.tween(this.btnBingo.node).repeatForever(cc.sequence(cc.fadeIn(.2), cc.fadeOut(.2)));
      ...
      showWin(winPrize) {
        ...
        this.lbWin.string = Utils_1.default.formatNumber(winPrize);
